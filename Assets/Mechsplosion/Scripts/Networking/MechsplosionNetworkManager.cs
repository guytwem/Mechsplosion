...
{
    public class MechsplosionNetworkManager : NetworkManager
    {
        /// <summary>
        ...
        public MechsplosionNetworkDiscovery discovery;
        ...
        /// </summary>
        public MechsplosionPlayerNet GetPlayerForId(byte _playerId)
        {
            MechsplosionPlayerNet player;
        ...
        public void AddPlayer(MechsplosionPlayerNet _player)
        {
        ...
        protected void AssignPlayerId(GameObject _playerObj)
        {
            ...
            MechsplosionPlayerNet player = _playerObj.GetComponent<MechsplosionPlayerNet>();
            player.playerId = id;
