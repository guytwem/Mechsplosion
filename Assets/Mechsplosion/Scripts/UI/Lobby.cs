...
namespace Mechsplosion.UI
{
    public class Lobby : MonoBehaviour
    {
        ...
        private MechsplosionPlayerNet localPlayer;

        public void AssignPlayerToSlot(MechsplosionPlayerNet _player, bool _left, int _slotId)
        {
        ...
        public void OnPlayerConnected(MechsplosionPlayerNet _player)
        {
            bool assigned = false;
        ...
        private bool AllPlayersReady()
        {
            ...
            return playerCount >= requiredPlayerCount && MechsplosionNetworkManager.Instance.IsHost;
        }
    }
}
